...
@endsection
              ...
              {{--  <!-- ===== Preloader Start ===== -->
                <include src=" public/partials/preloader.html"></include>
                <!-- ===== Preloader End ===== -->

                <!-- ===== Page Wrapper Start ===== -->
                <div class="flex h-screen overflow-hidden">
                  <!-- ===== Sidebar Start ===== -->
                  <include src="public/partials/sidebar.html"></include>
                  <!-- ===== Sidebar End ===== -->
                        ...
                        >
                          ...
                          <nav>
                            <ol class="flex items-center gap-2">
                              <li>
                                <a class="font-medium" href="public/index.html">Dashboard /</a>
                              </li>
