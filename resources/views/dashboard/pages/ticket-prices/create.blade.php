			...
			<div class="bg-white dark:bg-meta-4 dark:bg-none px-5 pt-6 pb-8 shadow-default dark:shadow-none rounded-[10px] p-5">
				...
				<form action="{{ route('dashboard.ticket-prices.store') }}" method="POST" class="lg:col-span-2 col-span-1">
					...
					<div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
						...
						<div class="w-full sm:w-1/2">
							<label class="mb-3 block text-sm font-medium text-black dark:text-white" for="is_promotion">En Promotion?</label>
							<div class="relative">
								<span class="absolute left-4.5 top-4">
					...
					<div class="flex justify-end gap-4.5">
						<a href="{{ route('dashboard.ticket-prices') }}" class="flex justify-center rounded border border-stroke px-6 py-2 font-medium text-black hover:shadow-1 dark:border-strokedark dark:text-white">
							Annuler
						</a>
