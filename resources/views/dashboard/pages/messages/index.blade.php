					...
					<div class="no-scrollbar max-h-full space-y-2.5 overflow-auto">
						...
						<div class="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
							<div class="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
								<img src="{{ asset('assets/images/user/user-01.png') }}" alt="profile" class="h-full w-full object-cover object-center" />
				...
				<div class="sticky flex items-center justify-between border-b border-stroke px-6 py-4.5 dark:border-strokedark">
					<div class="flex items-center">
						<div class="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
							<img src="{{ asset('assets/images/user/user-01.png') }}" alt="avatar" class="h-full w-full object-cover object-center" />
						</div>
						<div>
