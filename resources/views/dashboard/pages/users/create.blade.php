@php
	...
	$breadcrumbs = [
	    ['title' => __('users.create.user_list'), 'route' => route('dashboard.user.list')],
	    ['title' => $title],
	];
@endphp
...
<x-dashboard.layout :title="$title" :breadcrumb="$breadcrumbs">
	<div class="border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark rounded-[10px] p-5">
		...
		<form action="{{ route('dashboard.user.create.post') }}" method="POST" enctype="multipart/form-data">
			@csrf
			<section>
				...
				<div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							...
							<input
								...
								type="text" name="nom" id="Nom" placeholder="Devid Jhon" value="{{ old('nom') }}" required>
						</div>
					</div>
					...
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							...
							<input
								class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
								type="text" name="prenom" id="Prenom" placeholder="Rene Mode" value="{{ old('prenom') }}" required>
						</div>
					</div>
				</div>
				<div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							...
							<input
								class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
								type="email" name="email" id="email" placeholder="exemple@email.com" value="{{ old('email') }}"
								required>
						</div>
					</div>
					...
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							...
							<input
								class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
								type="tel" name="telephone" id="telephone" placeholder="+XXX XXXX XXXX" value="{{ old('telephone') }}"
								required>
						</div>
					</div>
				</div>
				<div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							...
							<input
								class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
								type="text" name="username" id="username" placeholder="charly99" value="{{ old('username') }}">
						</div>
					</div>
					...
					<div class="w-full sm:w-1/2">
						...
						<div class="relative">
							<input
								...
								placeholder="mm/dd/yyyy" name="birth_date" data-class="flatpickr-right" value="{{ old('birth_date') }}" />
				...
				<div class="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
					<div class="w-full sm:w-1/2">
						...
						<input
							...
							type="text" name="ville" id="ville" placeholder="Montreal" value="{{ old('ville') }}">
					</div>
