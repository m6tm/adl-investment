                ...
                <div class="w-full px-8 py-4">
                            ...
                            <div class="w-96">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        type="text" name="name" id="name" placeholder="Devid Jhon" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-5.5">
                            <div class="w-96">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                        type="text" name="first_name" id="first_name" placeholder="Rene Mode" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-5.5">
                            <div class="w-96">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                        type="tel" name="phone" id="phone" placeholder="+XXX XXXX XXXX" required>
                                </div>
                            </div>
                        </div>
                        <div class="mb-5.5">
                            <div class="w-96">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        class="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 font-medium text-black focus:border-primary focus-visible:outline-none dark:border-slate-100 dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                        type="pseudo" name="amount" id="amount" placeholder="23">
                                </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="grid justify-items-center mt-20">
                        <div class="rounded-full ">
                            <img src="{{ asset('assets/img/portfolio/télécharger.jpg') }}" class="rounded-full h-48 h-48" alt="User">
                        </div>
