...
@section('content')
    <main id="aboutus">
        ...
        <!-- About Section -->
        <section id="aboutus" class="about section padding-vert">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="content ps-0 ps-lg-5">
                            <ul>
                                <li><i class="bi bi-check-circle-fill"></i> <span>He of his in its price always and feedback
                                        of films.</span></li>
                                <li><i class="bi bi-check-circle-fill"></i> <span>Towards sight as not and each and, good.
                                    </span></li>
                                <li><i class="bi bi-check-circle-fill"></i> <span>Tone, the of preparations never a even
                                        viable a. </span></li>
                            </ul>
                        </div>
        ...
        <section id="aboutus" class="team section padding-vert">
                                    ...
                                    <div class="col-xl-5 col-md-7 col-sm-10">
                                        <div class="single-box wow fadeInLeft">
                                            <div class="text-area text-end">
                                                <h4>Set A Budget.</h4>
                                                <p>Playing the lottery is gambling, so keep it fun by treating it as part of
                                        ...
                                        <div class="single-box wow fadeInRight">
                                            ...
                                            <div class="text-area">
                                                ...
                                                <p>There are 5 exciting draw-based jackpot you can try one or all of them.
                                                    like powerball etc. & There are many variations...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
