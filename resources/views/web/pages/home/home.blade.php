            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-item position-relative">
                        ...
                        <a href="assets/img/Nobody -「AMV」- Anime MV.mp4 {{ route('tutoriel') }}"  class="glightbox pulsating-play-btn justify-content-center"></a>
                        </div>
                    </div>
                </div><!-- End Service Item -->
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-item position-relative">
                        ...
                        <a href="assets/img/Nobody -「AMV」- Anime MV.mp4 {{ route('services-details') }}"  class="glightbox pulsating-play-btn"></a>
                        </div>
                    </div>
                </div><!-- End Service Item -->
