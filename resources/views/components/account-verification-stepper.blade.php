@switch($status)
    @case($DOCUMENT_STATUS::PENDING)
        <div data-tab-step class="w-[300px] h-[200px] mx-auto border-slate-200 border-[2px] cursor-pointer rounded-lg flex flex-col justify-center items-center">
            ...
            <small class="mt-2 text-slate-500 dark:text-slate-300">En cours de vérification</small>
            <span>{{ $document }}</span>
        </div>
    @break
    ...
    @case($DOCUMENT_STATUS::VERIFIED)
        <div data-tab-step class="w-[300px] h-[200px] mx-auto border-slate-200 border-[2px] cursor-pointer rounded-lg flex flex-col justify-center items-center">
            ...
            <small class="mt-2 text-slate-500 dark:text-slate-300">Vérifié avec succès</small>
            <span>{{ $document }}</span>
        </div>
    @break
    ...
    @case($DOCUMENT_STATUS::REFUSED)
        <div data-tab-step class="w-[300px] h-[200px] mx-auto border-slate-200 border-[2px] cursor-pointer rounded-lg flex flex-col justify-center items-center">
            ...
            <small class="mt-2 text-slate-500 dark:text-slate-300">Document refusé</small>
            <span>{{ $document }}</span>
        </div>
    @break
    ...
    @default
        <div data-tab-step class="w-[300px] h-[200px] mx-auto border-slate-200 border-[2px] cursor-pointer rounded-lg flex flex-col justify-center items-center">
            ...
            <small class="mt-2 text-slate-500 dark:text-slate-300">En attente de soumission</small>
            <span>{{ $document }}</span>
        </div>
