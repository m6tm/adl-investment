<div class="data-table-common data-table max-w-full overflow-x-auto">
	<table class="table w-full table-auto" id="WheelConfigsTable">
		<thead>
			<tr>
				<th>
				...
				<th>
					<div class="flex items-center gap-1.5">
						<p class="text-[16px]">Ticket Price</p>
						<div class="inline-flex flex-col space-y-[2px]">
							<span class="inline-block">
								<svg class="fill-current" width="10" height="5" viewBox="0 0 10 5" fill="none"
									xmlns="http://www.w3.org/2000/svg">
				...
				<th>
					<div class="flex items-center gap-1.5">
						<p class="text-[16px]">Nombre à tirer</p>
						<div class="inline-flex flex-col space-y-[2px]">
							<span class="inline-block">
								<svg class="fill-current" width="10" height="5" viewBox="0 0 10 5" fill="none"
									xmlns="http://www.w3.org/2000/svg">
