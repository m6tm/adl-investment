    ...
    <div class="flex flex-grow items-center justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                @if (auth()->user()->hasAnyRoles($USER_ROLE::PLAYER))
                    ...
                    <li class="relative flex items-center space-x-2">
                        ...
                        <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-orange-100 dark:bg-orange-100 hover:text-primary dark:border-strokedark dark:text-white"
                ...
                <li>
                    <!-- Dark Mode Toggler -->
                    <label class="relative m-0 block h-7.5 w-14 rounded-full" id="darkModeToggler">
