...
<body>
    ...
    @endphp
	<div
		class="rounded-sm h-screen border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
		<div class="mx-auto max-w-[410px]">
			<img src="{{ asset('assets/img/illustration-01.svg') }}" alt="illustration">
			...
			<div class="mt-7.5 text-center">
				...
				<a href="{{ $authed ? route('dashboard') : route('home') }}"
