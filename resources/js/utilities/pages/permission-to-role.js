...
document.addEventListener("DOMContentLoaded", () => {
  const permissionToRoles = document.querySelectorAll("#permissionToRole");
  // biome-ignore lint/complexity/noForEach: <explanation>
  permissionToRoles.forEach((permissionToRole) => {
      const dataTable = new DataTable(permissionToRole, {
